        ...
        <ul class="nav nav-tabs nav-tabs-left">
            <li class="active">
                <a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> 
                    <?php echo get_phrase('ficha_aluno'); ?>
                </a></li>
            <?php
            ...
            <li >
                <a  href="#" onclick="ShowHideDIV('botao_submit', 1); alert('Ficha Habilitada para Editar')"   >
                    <i class="icon-wrench"></i> <?php echo get_phrase('editar_Ficha_do_aluno'); ?>
                </a>
            </li>
        </ul>
        <!------CONTROL TABS END------->
        ...
        <div class="tab-pane box" id="add" style="padding: 5px">
            ...
            <div class="box-content">
                ...
                <div class="form-actions">
                  <button type="submit" class="btn btn-gray"><?php echo get_phrase('Editar Ficha do aluno'); ?></button>
                  </div>
                 </div> 
