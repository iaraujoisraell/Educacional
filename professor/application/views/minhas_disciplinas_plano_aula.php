<html >
    ...
    <script>
        ...
        function buscar_paginacao_receber_pagamento() {
            ...
            //se encontrou o estado
                var url = 'index.php?admin/carrega_table_minhas_disciplinas_plano_aula/';  //caminho do arquivo php que irá buscar as cidades no BD
                $.get(url, function (dataReturn) {
                        ...
                        <div class="col-lg-12">
                            <div class="page-title">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active">Disciplinas Plano de Aula</li>
                                </ol>
                            </div>
                        </div>
                        <!-- /.col-lg-12 -->
