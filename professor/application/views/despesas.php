<html >
    ...
    <script>
        ...
        function buscar_paginacao_despesas() {
            ...
            var url = 'index.php?admin/carrega_table_despesas/' + status + '/' + mes_de + '/' + ano_de + '/' + mes_ate + '/' + ano_ate;  //caminho do arquivo php que irá buscar as cidades no BD
                                                        ...
                                                        <div class="controls">
                                                            <div  id="load_periodo_letivo">
                                                                ...
                                                                $sql_mes_de = "SELECT month (cpr_dt_vencimento) as mes
                                                                            ...
                                                                            where year (cpr_dt_vencimento) <= $ano_atual and cpr_nb_tipo = 2
                                                                            group by mes
                                                                            order by mes";
    ...
    ?>
                                        ...
                                        <table class="table  table-striped  " width="100%"  cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td width="20%">
                                                    <div class="control-group">
                                                        <label class="control-label"><?php echo get_phrase('Fornecedor'); ?></label>
                                                        <div class="controls">
                                                            <input type="text" name="busca" id="busca" class="input-search" alt="lista-clientes" placeholder="Procurar Fornecedor" />
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="flexModalLabel">Nova Conta a Pagar</h4>

                    </div>

                    <?php echo form_open('admin/despesas/create', array('class' => 'form-vertical validatable', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
                    <form method="post" action="<?php echo base_url(); ?>index.php?admin/despesas/create/" class="form-horizontal validatable" enctype="multipart/form-data">
                        ...
                        <div style="margin-left: 20px;" class="modal-body">
                                ...
                                <tr>
                                    <td >
                                        ...
                                        <select class="input" name="fornecedor" style="height: 30px; width: 410px;">
                                            <?php
                                            $sql_curso2 = "SELECT * FROM siga_financeiro.fornecedor order by for_tx_razao_social";
                            ...
                            <table>
                                <tr>
                                    <td>
                                        <font size="4px;">    Observações</font>
                                    </td>
                                </tr>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-green" >Criar Despesas</button>
                        </div>
                    </form>
                </div>
                <!-- /.modal-content -->
        ...
        <div class="modal modal-flex fade" id="editar_fornecedor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <?php echo form_open('admin/despesas/efetuar_pagamento/', array('class' => 'form-horizontal validatable', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
                    ...
                    <div style="margin-left: 20px;" class="modal-body">
                        <table width="100%">
                            <tr>
                                <td width="30%">
                                    <font style="color: #696969;" size="2">  Fornecedor   </font><font color="#ff0000"> </font>
                                </td>
                                <td width="70%">
        ...
        <div class="modal modal-flex fade" id="editar_fornecedor2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <?php echo form_open('admin/alterar_despesa/', array('class' => 'form-horizontal validatable', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
                         ...
                         <td>
                             <div id="fornecedor_novo" style="display: none">
                                 <select class="input" name="novo_fornecedor_edit" id="novo_fornecedor_edit" onchange="ShowHideDIV('fornecedor_editar', 0);" style="height: 30px; width: 390px;">
                                    ...
                                    <?php
                                    $sql_curso22 = "SELECT * FROM siga_financeiro.fornecedor order by for_tx_razao_social";
...
<?php echo form_open('admin/despesas/delete/', array('class' => 'form-horizontal validatable', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
