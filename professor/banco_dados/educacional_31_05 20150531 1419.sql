...
CREATE TABLE `horario` (
  ...
  CONSTRAINT `fk_horario_turno1` FOREIGN KEY (`turno_id`) REFERENCES `turno` (`turno_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=3602 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `periodo_letivo` (`periodo_letivo_id`,`periodo_letivo`,`periodo_letivo_descricao`,`dias_letivos`,`data_inicio`,`data_prev_termino`,`data_termino`,`periodo_encerrado`,`ano`,`semestre`) VALUES 
 (1,'2015/1','1o. Semestre de 2015',150,'2015-02-10','2015-07-20',NULL,1,2015,1);
...
CREATE TABLE `professor_turma` (
  `professor_turma_id` int(11) NOT NULL,
  ...
  CONSTRAINT `fk_professor_turma_turma1` FOREIGN KEY (`turma_id`) REFERENCES `turma` (`turma_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `turma` (
  ...
  `periodo_letivo_id` int(11) NOT NULL,
  `status` int(11) NOT NULL COMMENT '1 - Aberta\n0 - Fechada',
  `horario_id` int(11) DEFAULT NULL,
  `periodo_id` int(11) NOT NULL,
  `matriz_id` int(11) NOT NULL,
  PRIMARY KEY (`turma_id`),
  KEY `fk_turma_parametrizacao_curso_periodo1` (`periodo_letivo_id`) USING BTREE,
  KEY `FK_turma_matriz` (`matriz_id`),
  KEY `FK_turma_periodo` (`periodo_id`),
  KEY `FK_turma_horario` (`horario_id`),
  CONSTRAINT `FK_turma_1` FOREIGN KEY (`periodo_letivo_id`) REFERENCES `periodo_letivo` (`periodo_letivo_id`),
  CONSTRAINT `FK_turma_horario` FOREIGN KEY (`horario_id`) REFERENCES `horario` (`horario_id`),
  CONSTRAINT `FK_turma_matriz` FOREIGN KEY (`matriz_id`) REFERENCES `matriz` (`matriz_id`),
  CONSTRAINT `FK_turma_periodo` FOREIGN KEY (`periodo_id`) REFERENCES `periodo` (`periodo_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
...
INSERT INTO `turma` (`turma_id`,`tur_tx_descricao`,`periodo_letivo_id`,`status`,`horario_id`,`periodo_id`,`matriz_id`) VALUES 
 (1,'ADM 11',1,1,NULL,1,1),
 (2,'ADM 21',1,1,NULL,2,1);
