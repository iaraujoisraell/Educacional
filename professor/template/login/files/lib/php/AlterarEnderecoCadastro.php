...
include '../../../connections/conexao.php';
    ...
    $estado       = $_POST['estado'];   
        ...
        $sqlPegarIdEnd = "SELECT ed.id_endereco as IdEndereco FROM cliente_endereco ce INNER JOIN endereco ed ON ed.id_endereco = ce.id_endereco where ed.tipo=1 and ce.id_cliente=".$idUsuario;
       ...
       mysql_query($sqlUpdateEnderecoEntrega) or die(mysql_error()); 
        ...
        ?>
        <script>
            window.location.href = '../../../AlterarEnderecoCadastro.php?statusSucessoAlt=erro';
        </script>        
