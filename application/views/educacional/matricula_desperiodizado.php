        ...
        <ul class="nav nav-tabs nav-tabs-left">
            <li class="active">
                <a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> 
                    <?php echo get_phrase('MATRÍCULA DE ALUNO DESPERIODIZADO'); ?>
                </a></li>
...
<script>
    ...
    function buscar_paginacao() {
        ...
        if ((aluno) || (curso != '0') || (turma != '0')) {
            var url = 'index.php?educacional/carrega_table_paginacao_desperiodizado/' + curso + '/' + turma + '/' + aluno;  //caminho do arquivo php que irá buscar as cidades no BD
            $.get(url, function (dataReturn) {
    ...
    function buscar_ficha_periodizado(candidato_id) {
         var candidato = candidato_id;//$('#candidato_id').val(); 
         //se encontrou o estado
        if (candidato) {
            var url = 'index.php?educacional/carrega_ficha_desperiodizado/' + candidato ;  //caminho do arquivo php que irá buscar as cidades no BD
            $.get(url, function (dataReturn) {
    ...
    function adicionar_disciplina_desperiodizado() {
        ...
        //se encontrou o estado
            ...
            $.get(url, function (dataReturn) {
                $('#load_add_disciplina_desperiodizado').html(dataReturn);  //coloco na div o retorno da requisicao
            });
