        ...
        <ul class="nav nav-tabs nav-tabs-left">
           <li class="active">
                <a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> 
                 ...
                 <font style="color: #ffffff; font-size: 16px; margin-top: 45px; margin-left: 20px;"> <?php echo get_phrase('MATRÍCULA VIA VESTIBULAR'); ?></font>
                    ...
                    <tr>
                        <td>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('Vestibular'); ?></label>
                                <div class="controls">
