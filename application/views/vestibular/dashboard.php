            ...
            <div class="action-nav-normal">
                <div class="row-fluid">
                    ...
                    <div class="span2 action-nav-button">
                        <a href="<?php echo base_url(); ?>index.php?admin/candidato">
                            <img src="<?php echo base_url(); ?>template/images/icons_menu/candidato.png" />
                            <span><?php echo get_phrase('Consulta Candidatos'); ?></span>
                        </a>
                    </div>
                    <div class="span2 action-nav-button">
                        <a href="<?php echo base_url(); ?>index.php?admin/vestibular">
                            <img src="<?php echo base_url(); ?>template/images/icons_menu/vestibular.png" />
                            <span><?php echo get_phrase('Vestibular'); ?></span>
                        </a>
                    </div>
                    <div class="span2 action-nav-button">
                        <a href="<?php echo base_url(); ?>index.php?admin/Chamada">
                            <img src="<?php echo base_url(); ?>template/images/icons_menu/chamada.png" />
                            <span><?php echo get_phrase('Chamada'); ?></span>
                        </a>
                    </div>
