<div class="tab-pane box active" id="edit" style="padding: 5px">
  <div class="box-content">
        <?php foreach ($edit_data as $row): 
            ...
            ?>
            <?php echo form_open('educacional/matriz_disciplina/do_update/' . $row['disciplina_id'], array('class' => 'form-horizontal validatable', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
         <div class="padded">
                                          <div class="control-group">
                                                <label class="control-label"><?php echo get_phrase('cód_disciplina'); ?></label>
                                                <div class="controls">
                                                    <input type="text" class="validate[required]" value="<?php echo $row['disc_tx_abrev']; ?>" style="text-transform: uppercase;border-radius:5px;" name="curso"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="validate[required]" value="<?php echo $row['disc_tx_descricao']; ?>" style="text-transform: uppercase;border-radius:5px;" name="abreviatura"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" value="<?php echo $row['carga_horaria']; ?>" style="text-transform: uppercase;border-radius:5px;" name="habilidade"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" value="<?php echo $row['credito']; ?>" style="text-transform: uppercase;border-radius:5px;" name="estagio"/>
                                                </div>
                                            </div>
