...
INSERT INTO `cursos` (`cursos_id`,`cur_tx_descricao`,`cur_tx_duracao`,`cur_tx_abreviatura`,`cur_nb_ativ_comp_obrigatoria`,`cur_nb_estagio_obrigatoria`,`cur_fl_valor`,`cur_tx_habilitacao`,`cur_tx_coordenador`,`instituicao_id`,`modalidade`) VALUES 
 ...
 (0000000004,'testre','8 SEMESTRES','teste',444,44,700,'teste','teste',1,NULL),
 (0000000005,'testess','8 SEMESTRES','testess',4444,44,1880,'testess','testre',1,NULL);
...
CREATE TABLE `matriz` (
  ...
  `mat_nb_total_hora` int(11) NOT NULL,
  `mat_tx_semestre` varchar(2) DEFAULT NULL,
  `cursos_id` int(10) unsigned zerofill NOT NULL,
  PRIMARY KEY (`matriz_id`),
  KEY `fk_matriz_curso1` (`cursos_id`),
  CONSTRAINT `fk_matriz_curso1` FOREIGN KEY (`cursos_id`) REFERENCES `cursos` (`cursos_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
