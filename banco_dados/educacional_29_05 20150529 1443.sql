...
) ENGINE=MyISAM AUTO_INCREMENT=3493 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Definition of table `parametrizacao_curso_periodo`
--

DROP TABLE IF EXISTS `parametrizacao_curso_periodo`;
CREATE TABLE `parametrizacao_curso_periodo` (
  ...
  CONSTRAINT `fk_parametrizacao_curso_periodo_matriz1` FOREIGN KEY (`matriz_id`) REFERENCES `matriz` (`matriz_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_parametrizacao_curso_periodo_periodo_letivo1` FOREIGN KEY (`periodo_letivo_id`) REFERENCES `periodo_letivo` (`periodo_letivo_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_parametrizacao_curso_periodo_turno1` FOREIGN KEY (`turno_id`) REFERENCES `turno` (`turno_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `parametrizacao_curso_periodo`
--

/*!40000 ALTER TABLE `parametrizacao_curso_periodo` DISABLE KEYS */;
/*!40000 ALTER TABLE `parametrizacao_curso_periodo` ENABLE KEYS */;
...
CREATE TABLE `turma` (
  ...
  CONSTRAINT `fk_turma_parametrizacao_curso_periodo1` FOREIGN KEY (`parametrizacao_curso_periodo_id`) REFERENCES `parametrizacao_curso_periodo` (`parametrizacao_curso_periodo_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
