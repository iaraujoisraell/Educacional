...
<div class="primary-sidebar">
	...
	<ul class="nav nav-collapse collapse nav-collapse-primary">
		...
		<li >
			<span class="glow"></span>
				<a href="<?php echo base_url();?>index.php?admin/dashboard" rel="tooltip" data-placement="right" 
                	data-original-title="<?php echo get_phrase('Módulos');?>">
			...
			<span class="glow"></span>
				<a href="<?php echo base_url();?>index.php?admin/processo" rel="tooltip" data-placement="right" 
        ...
        <?php
              ...
              WHERE usuarios_id = $usuarios_id AND modulos.modulos_id = '1' ORDER BY nome")->result_array();
			...
			<span class="glow"></span>
				<a href="<?php echo base_url(); ?><?php echo $row2['men_tx_url'] ?>" rel="tooltip" data-placement="right" 
                    ...
                    <i class="fa <?php echo $row2['men_tx_img']; ?>"></i>
