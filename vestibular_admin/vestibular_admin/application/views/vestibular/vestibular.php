        ...
        <ul class="nav nav-tabs nav-tabs-left">
            ...
            <li>
                <a href="#add" data-toggle="tab"><i class="icon-plus"></i>
                    <?php echo get_phrase('novo_vestibular'); ?>
                </a></li>
        </ul>
        <!------CONTROL TABS END------->
    ...
    <div class="box-content padded">
        <div class="tab-content">
                    ...
                    <div class="box-content">
                        <div id="dataTables">
                            <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                                ...
                                <th><div><?php echo get_phrase('data_vestibular'); ?></div></th>
                                <th><div><?php echo get_phrase('inicio_inscricoes'); ?></div></th>
                                <th><div><?php echo get_phrase('fim_inscricoes'); ?></div></th>
                                <th><div><?php echo get_phrase('divulgacao_resultado'); ?></div></th>
                                <th><div><?php echo get_phrase('tipo'); ?></div></th>
                                <th><div><?php echo get_phrase('hora'); ?></div></th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($vestibular as $row):
                                        ...
                                        <tr>
                                            ...
                                            <td><?php
                                                if ($row['vest_tx_semestre'] == 'I') {
                                                    echo "I ";
                                                } else if ($row['vest_tx_semestre'] == 'II') {
                                                    echo "II ";
                                                }
                                                ?></td>
                                            <td><?php echo date('d/m/Y', strtotime($row['vest_dt_realizacao'])); ?></td>
                                            <td><?php echo date('d/m/Y', strtotime($row['vest_dt_inscricao'])); ?></td>
                                            <td><?php echo date('d/m/Y', strtotime($row['vest_dt_encerramento'])); ?></td>
                                            <td><?php echo date('d/m/Y', strtotime($row['vest_dt_resultado'])); ?></td>
                                            <td><?php
                                                ...
                                                ?></td>
                                            <td>de: <?php echo $row['vest_tx_inicio']; ?> as: <?php echo $row['vest_tx_fim']; ?></td>
                                            ...
                                            <td align="center">
                                                ...
                                                <a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url(); ?>index.php?admin/vestibular/delete/<?php echo $row['vestibular_id']; ?>')"
                                                   class="btn btn-red btn-small">
                                                    <i class="icon-trash"></i> <?php echo get_phrase('apagar'); ?>
                                                </a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
            ...
            <div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('admin/vestibular/create', array('class' => 'form-vertical validatable', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
                    <form method="post" action="<?php echo base_url(); ?>index.php?admin/vestibular/create/" class="form-horizontal validatable" enctype="multipart/form-data">
                        <div class="padded">
                                    ...
                                    <tr>
                                        <td width="25%">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="validate[required]" name="hora_inicio"/>
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="validate[required]" name="hora_fim"/>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td width="25%">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="validate[required]" name="data_inscricao"/>
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="validate[required]" name="data_encerramento"/>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td width="25%">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="validate[required]" name="data_resultado"/>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-gray"><?php echo get_phrase('criar _vestibular'); ?></button>
                        </div>
                    </form>                
                </div>                
            </div>
