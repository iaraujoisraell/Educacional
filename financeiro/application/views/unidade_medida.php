...
<html lang="en">
    ...
    <script>
        ...
        function carregaDadosGrupoJSon(id_fornecedor) {
            $.post(base_url + '/financeiro_nasser/index.php?/admin/dados_um', {
                unidade_medida_id: id_fornecedor
            }, function (data) {
                $('#unidade_medida_id').val(data.unidade_medida_id);
         ...
         function carregaDadosGrupoExcluiJSon(id_fornecedor) {
            $.post(base_url + '/financeiro_nasser/index.php?/admin/dados_um', {
                ...
                $('#unidade_medida_exclui_id').val(data.unidade_medida_id);
                 //aqui eu seto a o input hidden com o id do cliente, para que a edição funcione. Em cada tela aberta, eu seto o id do cliente. 
            }, 'json');
        }
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($unidade_medida as $row):
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="javascript:;"  data-target="#editar_fornecedor" ><?php echo ucfirst($row['um_tx_descricao']); ?></font></a></td>                                               
                                                        <td width="150px;" class="center"> 
                                                            <a href="javascript:;" class="btn btn-orange" data-target="#editar_fornecedor" onclick="janelaEditarGrupo(<?php echo $row['unidade_medida_id']; ?>)"> Editar</a>
                                                            <a href="javascript:;" class="btn btn-danger  "  data-target="#excluir_fornecedor"  onclick="janelaExcluirGrupo(<?php echo $row['unidade_medida_id']; ?>)" >Excluir</a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            </tbody>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="flexModalLabel">Nova Un. Medida</h4>

                    </div>

                    <?php echo form_open('admin/unidade_medida/create', array('class' => 'form-vertical validatable', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
                    <form method="post" action="<?php echo base_url(); ?>index.php?admin/unidade_medida/create/" class="form-horizontal validatable" enctype="multipart/form-data">
                        ...
                        <div style="margin-left: 20px;" class="modal-body">
                            ...
                            <table width="400">            
                                ...
                                <tr>
                                    <!--Razão Social-->
                                    <td>
                                        <input  type="text" required="true" onkeyup="this.value = this.value.toUpperCase()" name="um_tx_descricao" id="um_tx_descricao"  maxlength="250" />
                                    </td>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-green" >Criar Un. Medida</button>
                        </div>
                    </form>
                </div>
                <!-- /.modal-content -->
        ...
        <div class="modal modal-flex fade" id="editar_fornecedor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title" id="flexModalLabel">Editar Un. Medida</h4>
                    </div>



                    <?php echo form_open('admin/alterar_um/', array('class' => 'form-horizontal validatable', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
                        ...
                        <table>
                            <tr>
                                <td>
                                    ...
                                    <input name="unidade_medida_id"  id='unidade_medida_id' type="hidden" >
                                </td>                                                                                           
                            </tr>
        ...
        <div class="modal modal-flex fade" id="excluir_fornecedor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title" id="flexModalLabel">Excluir Un. Medida </h4>
                    </div>



                    <?php echo form_open('admin/unidade_medida/delete/', array('class' => 'form-horizontal validatable', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
                    ...
                    <div class="modal-body">
                        <table>
                            <tr>
                                <td>
                                    ...
                                    <input name="unidade_medida_exclui_id"  id='unidade_medida_exclui_id' type="hidden" >
                                </td>                                                                                           
                            </tr>
                        ...
                        <table width="400">            
                            <tr>
                                ...
                                <td>
                                    <h3>
                                        <i class="fa fa-eraser text-red"></i> Deseja excluir esta Un. Medida?
                                    </h3>
                                </td>
                                <!--Fantasia-->
