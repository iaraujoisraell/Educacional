...
<html>
    <head>
        ...
        <style>
           body{
                width: 100%;
                height: 100%;
                background-image:url(template/images/background3.jpg); 
    ...
    <div style="height: 40px;
        ...
        <h3 style="margin-top: 0px; margin-left: 10px;">Sistema Financeiro - Faculdade Boas Novas</h3>
            </div>
                ...
                <div class="span4 offset4">
                    <div class="padded">
                            ...
                            <script>
                             ...
                             <form method="post" action="<?php echo base_url(); ?>index.php?login/valida_login/" class="form-horizontal validatable" enctype="multipart/form-data">
                                    ...
                                    <div class="input-prepend">
                                        ...
                                        <input name="login" type="text" placeholder="<?php echo get_phrase('login');?>" autocomplete="off">
                                    </div>
                                    <div class="input-prepend">
                                        <span class="add-on" href="#">
                                        <i class="icon-key"></i>
                        ...
                        <div style="color:#006dcc;">
                        		...
                        		<center>&copy; 2016, Amazonia Global - Faculdade Boas Novas
                        		</center>
