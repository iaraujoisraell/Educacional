...
<div class="primary-sidebar">
    ...
    <div style="text-align:center; ">
        <a href="index.php?/admin/dashboard">
            <img src="<?php echo base_url(); ?>uploads/logo.png"  style="max-height:150px; max-width:150px;"/>
        </a>
    </div>
    <br />
        ...
        <li class="<?php if ($page_name == 'dashboard') echo 'dark-nav active'; ?>">
            ...
            <a href="<?php echo base_url(); ?>index.php?admin/dashboard" rel="tooltip" data-placement="right" 
               data-original-title="<?php echo get_phrase('dashboard_help'); ?>">
                ...
                <span><?php echo get_phrase('Módulos'); ?></span>
            </a>
        </li>
...
?>      
        ...
        ?>">
            ...
            <a class="accordion-toggle  " data-toggle="collapse" href="#settings_submenu" rel="tooltip" data-placement="right" 
               ...
               <i class="icon-wrench icon-1x"></i>
                ...
                <span><?php echo get_phrase('comercial'); ?><i class="icon-caret-down"></i></span>
            </a>
        ...
        if ($page_name == 'system_settings' ||
            ...
            echo 'in';
        ?>">
                <li class="<?php if ($page_name == 'clientes') echo 'active'; ?>">
                    <a href="<?php echo base_url(); ?>index.php?admin/fornecedor">
                                  <i class="icon-h-sign"></i>
                        <img src="<?php echo base_url(); ?>template/images/icons/system_settings.png" />
        <?php echo get_phrase('clientes'); ?>
                    </a>
                </li>
        ...
        ----fornecedor---
        <li class="<?php if ($page_name == 'fornecedor') echo 'dark-nav active'; ?>">
            <span class="glow"></span>
            <a href="<?php echo base_url(); ?>index.php?admin/fornecedor" rel="tooltip" data-placement="right" 
               data-original-title="<?php echo get_phrase('dashboard_help'); ?>">
                               <i class="icon-desktop icon-1x"></i>
                <img src="<?php echo base_url(); ?>template/images/icons/home.png" />
                <span><?php echo get_phrase('fornecedor'); ?></span>
            </a>
        </li>
