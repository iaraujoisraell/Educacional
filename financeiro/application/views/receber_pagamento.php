    ...
    <script>
        ...
        function buscar_paginacao_receber_pagamento() {
            ...
            if ((aluno) || (curso != '0') || (turma != '0')) {
                var url = 'index.php?admin/carrega_table_receber_pagamentos/' + curso + '/' + turma + '/' + aluno;  //caminho do arquivo php que irá buscar as cidades no BD
                $.get(url, function (dataReturn) {
                        ...
                        <div class="col-lg-12">
                            <div class="page-title">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active">Controle de Pagamentos</li>
                                </ol>
                            </div>
                        </div>
                        <!-- /.col-lg-12 -->
                                ...
                                <div class="portlet-body">
                                    <div class="table-responsive">  
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <select style="width: 300px;" class="input-search"  name="curso_busca" id="curso_busca" onchange="buscar_periodo_letivo()">
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <div  id="load_periodo_letivo">
                                                                <select style="width: 220px;" class="input-search"  name="periodo_letivo_busca" id="periodo_letivo_busca">
                                                ...
                                                <td>
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <div  id="load_turma">
                                                                <select style="width: 220px;" class="input-search"  name="turma_busca" id="turma_busca">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" style="width: 220px;" class="input-search"  onkeypress="this.value.toUpperCase();" name="aluno_busca" id="aluno_busca"     />
                                        ...
                                        <table>
                                            <tr>
                                                <td>
                                                    <input type="button" value="PESQUISAR" class="btn btn-blue btn-small" onclick="buscar_paginacao_receber_pagamento();">
                                                </td>
                                                <?php /*
                                                  <td>
                                                  <a  href="index.php?admin/teste_impressao" 	class="btn btn-gray btn-small">
