...
function next( el, next )
{
    ...
    <script>
        ...
        function janelaExcluirReceita(id_despesa) {
            // alert(id_fornecedor);
            //antes de abrir a janela, preciso carregar os dados do cliente e preencher os campos dentro do modal
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="page-title">
                                <h1>Controle de Pagamentos Avulsos

                                </h1>
                                <ol class="breadcrumb">
                                    <li><i class="fa fa-dashboard"></i>  <a href="index.php">Dashboard</a>
                                    </li>
                                    <li class="active">Pagamentos Avulsos</li>
                                </ol>
                            </div>
                        </div>
                        <!-- /.col-lg-12 -->
                            ...
                            <div class="portlet portlet-default">
                                <div class="portlet-heading">
                                    <div class="portlet-title">
                                        <h4> <button href="javascript:;" class="btn btn-primary" data-target="#flexModal" onclick="janelanovoFornecedor()()">Nova Despesa</button></h4> 
                                    </div>
        ...
        <div class="modal modal-flex fade" id="flexModal" tabindex="-1" role="dialog" aria-labelledby="flexModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <?php echo form_open('admin/contas_receber_avulso/create', array('class' => 'form-vertical validatable', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
                    <form method="post" action="<?php echo base_url(); ?>index.php?admin/contas_receber_avulso/create/" class="form-horizontal validatable" enctype="multipart/form-data">
        ...
        <div class="modal modal-flex fade" id="editar_fornecedor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title" id="flexModalLabel">Efetuar Pagamento </h4>
                    </div>

                    <?php echo form_open('admin/contas_receber_avulso/efetuar_pagamento/', array('class' => 'form-horizontal validatable', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
                    ...
                    <div style="margin-left: 20px;" class="modal-body">
                        <table width="100%">
                            <tr>
                                ...
                                <td width="70%">
                                    <input style="border: 1px solid #696969; border-radius: 3px 3px 3px 3px; width: 250px; height: 20px; text-transform: uppercase;" required="true" name="fornecedor_pg"  id="fornecedor_pg" type="text" >                                   
                                </td>                                                                                           
                            </tr>
        ...
        <div class="modal modal-flex fade" id="editar_fornecedor2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <?php echo form_open('admin/contas_receber_avulso/editar/', array('class' => 'form-horizontal validatable', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
                    <input type="hidden" name="conta_pagar_receber_id"  id="conta_pagar_receber_id"  >
                    <input type="hidden" name="categoria_codigo3"  id="categoria_codigo3"  >
                    ...
                    <div  style="width: 450px; margin: auto;" class="modal-body">
                            ...
                            <tr>
                                <td >
                                    <div id="fornecedor_editar" style="display: block">
                                        <input type="text" name="cliente"  id="cliente" class="input" style="border: 1px solid #696969; border-radius: 3px 3px 3px 3px; width: 390px; height: 20px; text-transform: uppercase;">
                                     </div>
                                </td>
                            </tr>
                           </table>
                        ...
                        <table >
                            <tr>
                                <td width="20%">
                                    <font size="4px;">    Pagamento </font><font style="color: red"> * </font>
                                </td>
                                <td width="21%">
                                    <font size="4px;">    Valor </font><font style="color: red"> * </font>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <input type="text"  id="data_vencimento3" onkeypress="mascara(this, mdata);" name="data_vencimento3" required="true" class="input" style="height: 30px; width: 200px;" >
                                </td>
                                <td style="margin-left: 5px;">
                                    <input type="text"  name="valor3"  id="valor3" onkeypress="mascara(this, mvalor);" required="true" class="input" style="height: 30px; width: 205px;" >
                                </td>
                            </tr>
                        </table>
                        ...
                        <table>
                            <tr>
                                <td>
                                    <font size="4px;">    Referente</font>
                                </td>
                            </tr>

                            <tr>
                                <td> <div id='historico'>
                                        <textarea class="input" name="historico3" id="historico3" style="height: 50px; width: 410px; text-transform: uppercase">
        ...
        <div class="modal modal-flex fade" id="excluir_fornecedor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title" id="flexModalLabel">Excluir Despesa </h4>
                    </div>



<?php echo form_open('admin/contas_receber_avulso/delete/', array('class' => 'form-horizontal validatable', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
...
<?php echo form_open('admin/contas_receber_avulso/cancelar/', array('class' => 'form-horizontal validatable', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
                        ...
                        <table>
                            <tr>
                                <td>
                                    ...
                                    <input name="codigo_fornecedor_excluir2_avulso"  id='codigo_fornecedor_excluir2_avulso' type="hidden" >
                                </td>                                                                                           
                            </tr>
