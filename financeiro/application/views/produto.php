...
a:active { text-decoration:none;  }
    ...
    <script>
        ...
        function carregaDadosClienteJSon(id_fornecedor) {
            $.post(base_url + 'financeiro/index.php?/admin/dados_produto_pagamento', {
 ...
 function carregaDadosFornecedorJSon(id_fornecedor) {
             $.post(base_url + '/financeiro/index.php?/admin/dados_produto_pagamento', {
                ...
                $('#produto_id2').val(data.produto_id);
                $('#descricao').val(data.descricao);
                                        ...
                                        <table id="example-table" class="table lista-clientes table-striped table-bordered table-hover table-green " >
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="background-color: #2C3E50; color: #ffffff">Produto</th>                                                                                                    
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($produto as $row):
                                                    ?>
                                                    <tr>
                                                        <td><a href="javascript:;"  data-target="#editar_fornecedor" onclick="janelaEditarCliente(<?php echo $row['produto_id']; ?>)"><?php echo $count++; ?></a></td>
                                                         <td><a href="javascript:;"  data-target="#editar_fornecedor" onclick="janelaEditarCliente(<?php echo $row['produto_id']; ?>)"><?php echo ucfirst($row['descricao']); ?></font></a></td>                                               
                                                      <td width="150px;" class="center"> 
                                                            <a href="javascript:;" class="btn btn-orange" data-target="#editar_fornecedor" onclick="janelaEditarCliente(<?php echo $row['produto_id']; ?>)"> Editar</a>
                                                       <a href="javascript:;" class="btn btn-danger  "  data-target="#excluir_fornecedor"  onclick="janelaExcluirFornecedor(<?php echo $row['produto_id']; ?>)" >Excluir</a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            </tbody>
        ...
        <div class="modal modal-flex fade" id="flexModal" tabindex="-1" role="dialog" aria-labelledby="flexModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <?php echo form_open('admin/produto_pagamento/create', array('class' => 'form-vertical validatable', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
                    <form method="post" action="<?php echo base_url(); ?>index.php?admin/produto_pagamento/create/" class="form-horizontal validatable" enctype="multipart/form-data">
                        ...
                        <div style="margin-left: 20px;" class="modal-body">
                            ...
                            <table width="400">            
                                <tr>
                                    <!--Razão Social-->
                                    <td>
                                        <font style="color: #696969;" size="2">  Produto  </font><font color="#ff0000">* </font>
                                    </td>
        ...
        <div class="modal modal-flex fade" id="editar_fornecedor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <?php echo form_open('admin/alterar_produto_pagamento/', array('class' => 'form-horizontal validatable', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
        ...
        <div class="modal modal-flex fade" id="excluir_fornecedor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <?php echo form_open('admin/excluir_produto_pagamento/', array('class' => 'form-horizontal validatable', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
                    ...
                    <div class="modal-body">
                        <table>
                            <tr>
                                <td>
                                    ...
                                    <input name="produto_id2"  id='produto_id2' type="hidden" >
                                </td>                                                                                           
                            </tr>
                        ...
                        <table width="400">            
                            <tr>
                                ...
                                <td>
                                    <h3>
                                        <i class="fa fa-eraser text-red"></i> Deseja excluir este Produto?
                                    </h3>
                                </td>
                                <!--Fantasia-->
