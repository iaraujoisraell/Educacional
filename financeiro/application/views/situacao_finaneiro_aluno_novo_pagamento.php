...
function SomenteNumero(e){
    ...
    <body>
                                ...
                                <div class="page-title">
                                    ...
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="active">Pagamento</li>
                                            <li class="fa fa-backward"> <a  href="index.php?admin/historico_financeiro_aluno/<?php echo $matricula; ?>">Voltar para Histórico Financeiro do Aluno</a></li>
       ...
       foreach ($mensalidade as $rowm):
                $mensalidade_id = $rowm['mensalidade_id'];
                $data_vencimento = $rowm['men_dt_vencto'];
                $data_vencimento_pgto = date("d/m/Y", strtotime($data_vencimento));    
                
                $sql_mt2133 = "SELECT * FROM siga_financeiro.mensalidade m "
                        . " left join siga_financeiro.movimento_financeiro mf on mf.mensalidades_id = m.mensalidade_id where m.mensalidade_id =  $mensalidade_id ";
                $uf_mt2133 = $this->db->query($sql_mt2133)->result_array();
                foreach ($uf_mt2133 as $rowm2):
                    $status_men = $rowm2['men_nb_status'];
                
                $valor_mensalidade = $rowm2['men_fl_valor'];
                $valor_pago = $rowm2['mf_db_valor'];
                
                $juros = $rowm2['mf_db_juros'];
                $desconto = $rowm2['mf_db_desconto'];
                $multa = $rowm2['multa'];
                $bolsa = $rowm2['bolsa'];
                
                $valor_real = $valor_mensalidade + $juros + $multa - $desconto - $bolsa;
                $valor_real2 = number_format($valor_real, 2, ',', '.');
                
                endforeach;

               $valor_apagar2 = $valor_real - $valor_pago;
                $valor_apagar = number_format($valor_apagar2, 2, ',', '.');
                
              // echo 'aki'. $valor_apagar;
            endforeach;
            ?>                                 
    ...
    function atualizar_valor_pagar() { 
           var valor_pagar_curso = <?php echo $valor_apagar2; ?>;
        ...
        <div style="width: 100%; background-color: #E0E7E8">
              <div style="margin:auto;  width: 450px;  "  >
                                            ...
                                            <table class="table lista-clientes table-striped table-bordered table-hover table-green " width="100%" style="border: 5px;" cellpadding="0" cellspacing="0" border="0" >
                                                    <?php echo form_open('admin/historico_financeiro_aluno/efetuar_pagamento', array('class' => 'form-vertical validatable', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
                                                    ...
                                                    <input type="hidden" value="<?php echo $mensalidade_id; ?>" name="mensalidade_id" id="mensalidade_id">
                                                       ...
                                                       <table >
                                                        ...
                                                        <table>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="right">
                                                                    <font style="text-align: right" >   <input type="text" placeholder="R$ 0.000,00" disabled="true" value="<?php echo $valor_apagar; ?>" name="valor_curso" onKeyPress="return(MascaraMoeda1(this, '.', ',', event))" id="valor_curso" required="true" class="input" style="height: 30px; width: 200px;text-align: right; " ></font>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        <table >
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <input type="text" onkeypress="return SomenteNumero(event); " onkeyup="document.getElementById('desconto2').value =  arred(((this.value / 100) * <?php echo $valor_apagar2; ?>),2); atualizar_valor_pagar();"  maxlength="3" minlength="1" placeholder="% de desconto" id="calendario3" id="desconto" name="desconto"  class="input" style="height: 30px; width: 200px;" >
                                                                </td>
                                                                <td align="right">
                                                        ...
                                                        <table >
                                                            ...
                                                            <tr>
                                                                ...
                                                                for (i = 0; i < meses_atrasados; i++) { 
                                                                  var valor_somado =  <?php echo $valor_apagar2; ?> + valor_com_juros;
                                                       ...
                                                       document.getElementById('juros2').value =  resultado_juros; atualizar_valor_pagar();"
                                                        ...
                                                        <table >
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <input type="text" onkeypress="return SomenteNumero(event);" 
                                                                           onkeyup="document.getElementById('multa2').value = arred(((this.value / 100) * <?php echo $valor_apagar2; ?>),2); atualizar_valor_pagar();"
                                    ...
                                    inner join periodo_letivo pl on pl.periodo_letivo_id = bp.periodo_letivo_id
                                                         ...
                                                         where ba.matricula_aluno_turma_id = $matricula_aluno_turma_id_pg and b.tipo = 1 order by bolsa_aluno_id desc";
                                                            ...
                                                            endforeach;
                                                             $valor_bolsa2 = ($soma_bolsa2/ 100) *  $valor_apagar;
                                                            ?>
                                                        <table >
                                                            <tr>
                                                                <td >
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <input type="text" value="<?php echo $soma_bolsa2; ?>" onkeypress="return SomenteNumero(event);" 
                                                                           onkeyup="document.getElementById('bolsa2').value = ((this.value / 100) * <?php echo $valor_apagar; ?>); atualizar_valor_pagar();"
                                    ...
                                    inner join periodo_letivo pl on pl.periodo_letivo_id = bp.periodo_letivo_id
                                                         ...
                                                         where ba.matricula_aluno_turma_id = $matricula_aluno_turma_id_pg and b.tipo = 2 order by bolsa_aluno_id desc";
                                                            ...
                                                            endforeach;
                                                            $novo_valorcurso = $valor_apagar - $valor_bolsa2;
                                                        ...
                                                        <table>
                                                            <tr>
                                                                <td align="right">
                                                                    <font size="4px;">   Valor SubTotal R$</font><font style="color: red">  </font>
                                                                </td>
                                                                <td align="right">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <input  type="text" readonly="true" name="valor_pago2"  id="valor_pago2" value="<?php echo $valor_apagar2; ?>"   onKeyPress="return(MascaraMoeda1(this, '.', ',', event))"   class="input" style=" height: 30px; width: 200px; text-align: right;background-color: #CCC;" >
                                                    ...
                                                    <div class="modal-footer">
                                                        <a  href="index.php?admin/historico_financeiro_aluno/<?php echo $matricula; ?>">
