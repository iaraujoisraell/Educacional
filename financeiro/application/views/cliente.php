...
a:active { text-decoration:none;  }
    ...
    <script>
        ...
        function carregaDadosClienteJSon(id_fornecedor) {
            $.post(base_url + '/nasser/index.php?/admin/dados_cliente', {
                            ...
                            <div class="portlet portlet-default">
                                <div class="portlet-heading">
                                    <div class="portlet-title">
                                        <h4> <button href="javascript:;" class="btn btn-primary" data-target="#flexModal" onclick="janelanovoFornecedor()()">Novo Cliente</button></h4> 
                                    </div>
                                                ...
                                                foreach ($cliente as $row):
                                                    ...
                                                    <tr>
                                                        <td><?php echo $count++; ?></td>
                                                         <td><?php echo ucfirst($row['for_tx_razao_social']); ?></td>
                                                     
                                                         <td><?php echo ucfirst($row['for_tx_cnpj']); ?></td>
                                                      <td><?php echo ucfirst($row['for_tx_email']); ?></td>
                                                   
                                                         <td>   <?php echo ucfirst($row['for_tx_fone']); ?></td>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="flexModalLabel">Novo Cliente</h4>

                    </div>

                    <?php echo form_open('admin/cliente/create', array('class' => 'form-vertical validatable', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
                    <form method="post" action="<?php echo base_url(); ?>index.php?admin/cliente/create/" class="form-horizontal validatable" enctype="multipart/form-data">
                        ...
                        <div style="margin-left: 20px;" class="modal-body">
                            ...
                            <table width="400">            
                                <tr>
                                    <!--Razão Social-->
                                    <td>
                                        <font style="color: #696969;" size="2">  Nome  </font><font color="#ff0000">* </font>
                                    </td>
                                ...
                                <tr>
                                    <!--Razão Social-->
                                    <td>
                                        <input style=" border: 1px solid #696969; border-radius: 3px 3px 3px 3px; width: 515px; height: 20px;" type="text" required="true" onkeyup="this.value = this.value.toUpperCase()" name="txrazaosocial" id="txrazaosocial"  maxlength="250" />
                                    </td>
                            ...
                            <table  width="400">            
                                <tr>
                                    <!--Telefone-->
                                    <td>
                                        <font style="color: #696969;" size="2">  Telefone  </font>
                                    </td>
                                    <!--Celular-->
                                    <td >
                                ...
                                <tr>
                                    <!--Telefone-->
                                    <td>
                                        <input style=" border: 1px solid #696969; border-radius: 3px 3px 3px 3px; width: 100px; height: 20px"  type="text"  onkeyup="this.value = this.value.toUpperCase()" name="txtelefone" id="txtelefone"  maxlength="15" />
                                    </td>
                                    <!--Celular-->
                                    <td>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-green" >Criar Cliente</button>
                        </div>
                    </form>
                </div>
                <!-- /.modal-content -->
        ...
        <div class="modal modal-flex fade" id="editar_fornecedor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-title" id="flexModalLabel">Editar Cliente </h4>
                    </div>



                    <?php echo form_open('admin/alterar_cliente/', array('class' => 'form-horizontal validatable', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
                    ...
                    <div style="margin-left: 20px;" class="modal-body">
                        ...
                        <table width="400">            
                            <tr>
                                <!--Razão Social-->
                                <td>
                                    <font style="color: #696969;" size="2">  Nome do Cliente  </font><font color="#ff0000">* </font>
                                </td>
                                <!--Fantasia-->
        ...
        <div class="modal modal-flex fade" id="excluir_fornecedor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <?php echo form_open('admin/excluir_cliente/', array('class' => 'form-horizontal validatable', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
                    ...
                    <div class="modal-body">
                        ...
                        <table width="400">            
                            <tr>
                                ...
                                <td>
                                    <h3>
                                        <i class="fa fa-eraser text-red"></i> Deseja excluir este Cliente?
                                    </h3>
                                </td>
                                <!--Fantasia-->
