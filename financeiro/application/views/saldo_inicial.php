<html >
    ...
    <script>
        ...
        function carregaDadosClienteJSon(id_fornecedor) {
            $.post(base_url + '/financeiro_web/index.php?/admin/dados_cliente2', {
        ...
        function carregaDadosProdutoJSon2(id_produto) {
            $.post(base_url + '/financeiro_nasser/index.php?/admin/dados_produto', {
                        ...
                        <div class="col-lg-12">
                            <div class="page-title">
                                ...
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active">Saldo Inicial</li>
                                </ol>
                            </div>
                        </div>
                        <!-- /.col-lg-12 -->
