...
--
-- Definition of table `cadastro_aluno`
--
...
--
-- Definition of table `dados_censo_aluno`
--
...
--
-- Dumping data for table `dados_censo_aluno`
--
...
--
-- Definition of table `dados_censo_vinculo_curso`
--
...
--
-- Dumping data for table `dados_censo_vinculo_curso`
--
...
) ENGINE=MyISAM AUTO_INCREMENT=4726 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Definition of table `matricula_aluno`
--
...
--
-- Definition of table `matricula_aluno_turma`
--
...
--
-- Dumping data for table `matricula_aluno_turma`
--
...
--
-- Definition of table `matriz_disciplina`
--
...
--
-- Dumping data for table `matriz_disciplina`
--
...
--
-- Definition of table `professor_turma`
--
