        ...
        <ul class="nav nav-tabs nav-tabs-left">
            <li class="active">
                <a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> 
                    <?php echo get_phrase('lista_professores'); ?>
                </a>
            </li>
            <li>
                <a href="#add" data-toggle="tab"><i class="icon-plus"></i>
                    <?php echo get_phrase('novo_professor'); ?>
                </a>
            </li>
                ...
                <div class="action-nav-normal">
                    <div class=" action-nav-button" style="width:300px;">
                        <a href="#" title="Users">
                            ...
                            <span>Total <?php echo count($professor); ?> Professor</span>
                        </a>
                    </div>
                </div>
                <div class="box">
                    <div class="box-content">
                        <div id="dataTables">
                            <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                                ...
                                <th><div><?php echo get_phrase('Dt. Nascimento'); ?></div></th>
                                <th><div><?php echo get_phrase('Email'); ?></div></th>
                                <th><div><?php echo get_phrase('login'); ?></div></th>
                                ...
                                <tbody>
                                    <?php
                                    $count = 1;
                                    foreach ($professor_cadastro as $row):
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                 <a href="<?php echo base_url(); ?>index.php?educacional/professor_disciplina/<?php echo $row['professor_id']; ?>" class="btn btn-green btn-small">
                                             
                                                    <i class="icon-list-alt"></i> <?php echo get_phrase('disciplinas'); ?>
                                                </a>
                                                <a data-toggle="modal" href="#modal-form" onclick="modal('editar_professor',<?php echo $professor_id; ?>)"class="btn btn-gray btn-small">
            ...
            <div class="tab-pane box" id="add_bolsa">
                <div class="box-content">
                    ...
                    <form method="post" action="<?php echo base_url(); ?>index.php?educacional/periodo_letivo/bolsa/" class="form-horizontal validatable" enctype="multipart/form-data">
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-gray"><?php echo get_phrase('vincular_bolsa'); ?></button>
                        </div>
                    </form>        
