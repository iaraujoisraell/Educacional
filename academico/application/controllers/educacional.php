    ...
    function bolsas($param1 = '', $param2 = '', $param3 = '') {
        ...
        if ($param1 == 'delete') {
             ...
             if ($numrows2 >= 1) {
                 ...
                 $this->session->set_flashdata('flash_message', get_phrase('Esta Bolsa tem vínculos em bolsas período e não pode ser excluída.'));
                 ?>
...
where  ca.cadastro_aluno_id != '' and desperiodizado = 1";
    ...
    function carrega_div_desperiorizado($param1 = '', $param2 = '', $param3 = '') {
            ...
            ?>
               <div class="control-group">
                                            <label class="control-label"><?php echo get_phrase('É um aluno desperiorizado?'); ?></label>
                                            <div class="controls">
